...
echo -e "${YELLOW}1) Установить ноду${NC}"
echo -e "${YELLOW}2) Показать логи${NC}"
echo -e "${YELLOW}3) Проверить хеш${NC}"
echo -e "${YELLOW}4) Зарегистрировать валидатора${NC}"
echo -e "${YELLOW}5) Удалить ноду${NC}"
